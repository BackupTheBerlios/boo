...
/**
 * Sincronizza tramite Subversion una directory locale rispetto
 * ad un repository remoto.
 */
public class Replicator {
	 ...
	 * @param workingCopy Directory in cui risiede la working copy.
	 */
	 ...
	 * specificate.
	 * @param repository URL del repository.
	 * @param username Nome utente sul server Subversion.
	 * @param password Password dell'utente sul server Subversion.
	 */
	...
	public static void main(String[] args) throws Exception {
		...
		Replicator r = new Replicator("/Users/Domenico/Polimi/IngSw/Eclipse Workspace/Boo");
		long l = r.update();
